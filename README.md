...
How To Install PROFESSOR-DDOS In Termux
...
$ git clone https://github.com/SourabhProfessor/PROFESSOR-DDOS.git

$ cd PROFESSOR-DDOS

$ chmod +x PROFESSOR-DDOS.py

$ python2 PROFESSOR-DDOS.py
